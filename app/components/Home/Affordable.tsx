      ...
      <div className="mx-auto flex h-full max-w-7xl flex-col items-center justify-center gap-10 text-center lg:flex-row">
        <div className="lg:w-[40%]">
          <h2 className="text-3xl font-bold text-gray-800">
            Trusted Leak Detection Services in California
          </h2>
          <p className="mt-4 text-gray-600">
            Need reliable leak detection solutions? Our team offers fast,
            professional, and affordable leak detection services. Whether it’s
            residential, commercial, or industrial, we’ve got you covered. Call
            now for expert service you can trust!
          </p>
        ...
        <div className="mt-8 flex flex-col justify-center gap-6 lg:flex-row ">
          ...
          <div className="flex w-full max-w-sm flex-col items-center rounded-lg bg-white p-6 shadow-md ">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-800">
              Affordable Leak Detection Solutions
            </h3>
            <p className="mt-2 text-gray-600">
              We offer cost-effective leak detection services tailored to your
          ...
          <div className="flex w-full max-w-sm flex-col items-center rounded-lg border border-main bg-white p-6 shadow-md">
            ...
            <p className="mt-2 text-gray-600">
              From minor leaks to major water damage, we provide a full range of
          ...
          <div className="flex w-full max-w-sm flex-col items-center rounded-lg bg-white p-6 shadow-md">
            ...
            <p className="mt-2 text-gray-600">
              ...
              keeping your property safe and leak-free without delays.
            </p>
          </div>
        </div>
      </div>
